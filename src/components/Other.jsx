  ...
  return (
    <div>
      <div className='flex justify-between item-center mt-10 gap-10'>
        ...
        <div className='card2 aspect-square w-[50%] flex grow-1 flex-col justify- items-start gap-2-start bg-[url("/building.png")] bg-bottom-right bg-cover p-5 rounded-xl'>
